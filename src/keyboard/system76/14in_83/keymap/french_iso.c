...
LAYOUT_ISO(
    ...
    K_CAPS, K_A, K_S, K_D, K_F, K_G, K_H, K_J, K_K, K_L, K_SEMICOLON, K_QUOTE, K_BACKSLASH,
    K_LEFT_SHIFT, K_INT_1, K_Z, K_X, K_C, K_V, K_B, K_N, K_M, K_COMMA, K_PERIOD, K_SLASH, K_RIGHT_SHIFT,
...
LAYOUT_ISO(
    K_ESC, K_MUTE, K_VOLUME_DOWN, K_VOLUME_UP, K_F4, K_F4, K_DISPLAY_TOGGLE, K_BRIGHTNESS_DOWN, K_BRIGHTNESS_UP, K_TOUCHPAD, K_CAMERA_TOGGLE, K_AIRPLANE_MODE, K_SUSPEND, K_PRINT_SCREEN, K_PLAY_PAUSE, K_NUM_LOCK, K_DEL,
    ...
    K_RIGHT_ALT, K_A, K_S, K_D, K_F, K_G, K_H, K_NUM_1, K_NUM_2, K_NUM_3, K_NUM_MINUS, K_QUOTE, K_BACKSLASH,
    K_KBD_BKL, K_INT_1, K_Z, K_X, K_C, K_V, K_B, K_N, K_NUM_0, K_COMMA, K_NUM_PERIOD, K_NUM_PLUS, K_RIGHT_SHIFT,
    K_LEFT_CTRL, KT_FN, K_LEFT_SUPER, K_LEFT_ALT, K_KBD_BKL, K_RIGHT_ALT, K_APP, K_HOME, K_UP, K_END,
    K_LEFT, K_DOWN, K_RIGHT
)
};
// uncrustify:on
